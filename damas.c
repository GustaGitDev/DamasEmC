...
void dispoemPecas(){ // Função que coloca as peças no tabuleiro. Onde o jogador 2 está na parte superior e o 1 está na 
...
void telaJogo(Jogador jogador1, Jogador jogador2){ // Tela do jogo em si conforme slide do projeto.
    ...
    printf("|   [6] Fazer jogada                                  [8] Encerrar             |\n");
    printf("+============================================================================+\n");
    printf("|                                                                            |\n");
